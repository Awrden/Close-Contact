...
function displayPotentialContact()
{
...
function displayContact(FirstName, LastName, Phone, Email, ID)
{
	...
	var updateContactId = `saveContactId('${FirstName}', '${LastName}', '${Email}', '${Phone}', '${ID}'); window.location.href="editcontact.html"`;  
...
function saveContactId(firstName, lastName, email, phone, id)
{
